...
function Search() {
  ...
  const showLocationForm = () => setDisplayLocationForm(!displayLocationForm);

  const showProductForm = () => setDisplayProductForm(!displayProductForm);
    ...
    <>
      ...
      <form className={`search-form ${displayLocationForm && "active-form"}`}>
        <section>
          <p>
            ...
            <select id="section" name="sections">
              <option defaultValue="">All Sections</option>
          ...
          <p>
            ...
            <select id="shelf" name="shelf_letter">
              <option defaultValue="">All Shelfs</option>
          ...
          <p>
            ...
            <select id="division" name="shelf_div">
              <option defaultValue="">All Divisions</option>
        ...
        <section>
          ...
          <p>
            <button onClick={showLocationForm}>Go Back</button>
          </p>
        </section>
      </form>
      <div
